...
class TestUser(unittest.TestCase):
    ...
    def test_type_longitude(self):
        ...
        '''
        self.new_place.longitude = 123.456
    ...
    def test_type_latitude(self):
        ...
        '''
        self.new_place.latitude = 45.678
    ...
    def test_type_price_by_night(self):
        ...
        '''
        self.new_place.price_by_night = 100
    ...
    def test_type_number_bathrooms(self):
        ...
        '''
        self.new_place.number_bathrooms = 3
    ...
    def test_type_description(self):
        ...
        '''
        self.new_place.description = "A beautiful place to stay"
    ...
    def test_type_user_id(self):
        ...
        '''
        self.new_place.user_id = "user123"
    ...
    def test_type_city_id(self):
        ...
        '''
        self.new_place.city_id = "city123"
